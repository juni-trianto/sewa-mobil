    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li @if ($page_folder == 'mobil') class="active" @endif> 
                    <a class="waves-effect waves-dark" href="{{ route('mobil') }}" >
            ...
            <div class="text-center mt-4">
                <a href="{{ route('logout') }}" class="btn waves-effect waves-light btn-info hidden-md-down text-white">
                    Logout
